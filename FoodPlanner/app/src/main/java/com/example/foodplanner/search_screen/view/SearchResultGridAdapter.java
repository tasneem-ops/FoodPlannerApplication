...
public class SearchResultGridAdapter extends RecyclerView.Adapter<SearchResultGridAdapter.ViewHolder>{
    Context context;
    List<SearchItem> itemsList;
    OnSearchClickListener listener;
    private static final String TAG = "MyAdapter";

    public SearchResultGridAdapter(Context context, List<SearchItem> itemsList, OnSearchClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        holder.titleTxt.setText(itemsList.get(position).getName());
        ...
        Glide.with(context).load(itemsList.get(position).getImageUrl())
    ...
    public void setList(List<SearchItem> itemsList){
        this.itemsList = itemsList;
    }
}
